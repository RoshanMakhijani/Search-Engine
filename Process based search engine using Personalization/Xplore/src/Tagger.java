...
public class Tagger 
{
	...
	public String tagging(String ai)
	{
		String s=new String();
		try {
			final POSDictionary POSD = new POSDictionary("D:/Sanjay/Eclipse Workspace/SEARCH ENG/Resources/tagdict.htm");
			PosTagger pt = new PosTagger("D:/Sanjay/Eclipse Workspace/SEARCH ENG/Resources/tag.bin.gz", POSD);
			s = pt.tag(ai);
			}
		catch(IOException e) 
		{
